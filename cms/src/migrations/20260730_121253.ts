...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'editor', 'subscriber', 'guest');
  CREATE TYPE "public"."enum_worker_logs_level" AS ENUM('info', 'warn', 'error');
  ...
  CREATE TABLE "videos" (
  	...
  	"category_id" integer,
  	"status" "enum_videos_status" DEFAULT 'ready' NOT NULL,
  ...
  CREATE TABLE "worker_logs" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"level" "enum_worker_logs_level" DEFAULT 'info' NOT NULL,
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_worker_logs_fk" FOREIGN KEY ("worker_logs_id") REFERENCES "public"."worker_logs"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "worker_logs_updated_at_idx" ON "worker_logs" USING btree ("updated_at");
  CREATE INDEX "worker_logs_created_at_idx" ON "worker_logs" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_worker_logs_id_idx" ON "payload_locked_documents_rels" USING btree ("worker_logs_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "worker_logs" CASCADE;
  ...
  DROP TYPE "public"."enum_worker_logs_level";
