      ...
      <section className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-brand-card via-brand-dark to-brand-card border border-brand-border p-8 md:p-12">
        <div className="max-w-2xl space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            <Link href="/news" className="flex items-center gap-2 bg-brand-card hover:bg-brand-border text-white px-6 py-3 rounded-lg font-semibold border border-brand-border transition-all">
              Read Articles
            </Link>
          </div>
        </div>
